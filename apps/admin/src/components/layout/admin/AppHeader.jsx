...
function AppHeader() {
  ...
  function toggleApplicationMenu() {
    setIsApplicationMenuOpen((currentValue) => !currentValue);
  }

  function handleSearchSubmit(event) {
    event.preventDefault();

    // Global search functionality will be implemented later.
  }
      ...
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/admin" className="flex items-center gap-2 lg:hidden">
            <span className="flex size-9 items-center justify-center rounded-lg bg-brand-500 font-semibold text-white">
              S
            </span>
        ...
        {/* Mobile: collapsible controls. Desktop: always visible */}
        <div
          className={`${
